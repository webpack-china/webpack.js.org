...
T> 如果你使用了 `webpack-dev-middleware` 而非 `webpack-dev-server`, 那么在你自选服务和应用上，就要使用 [`webpack-hot-middleware`](https://github.com/glenjamin/webpack-hot-middleware) 包，来启用 HMR。
